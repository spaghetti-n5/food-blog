    ...
    <Layout>
      <SEO title="About" />
        ...
        <div className={styles.textWrap}>
            ...
            <p>Un’altra parte importante della mia cucina è l’influenza spagnola data dai mille viaggi nella penisola iberica ma soprattutto dal mio fidanzato, originario della Comunità Valenciana, che mi ha trasmesso le ricette delle più comuni tapas dei bar spagnoli ed i segreti per realizzare un’originale e buonissima paella.</p>
